...
RECOVERY_VERSION := Samdroid.Net Recovery v0.1.3.b6
RECOVERY_AUTHOR := LeshaK / Xmister & Samdroid.Net
BASE_RECOVERY_VERSION := based on ClockworkMod v2.5.1.1

LOCAL_CFLAGS += -DRECOVERY_VERSION="$(RECOVERY_VERSION)"
LOCAL_CFLAGS += -DRECOVERY_AUTHOR="$(RECOVERY_AUTHOR)"
LOCAL_CFLAGS += -DBASE_RECOVERY_VERSION="$(BASE_RECOVERY_VERSION)"
